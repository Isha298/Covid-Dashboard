...
import "./App.css";
import covid from "./images/download.jfif";
...
const [totalStateWiseCount,setTotalStateWise]=useState([]);
...
setTotalStateWise(totalStateCount);
...
const stateSearch = (searchText) =>{
    ...
    setTotalStateWise(filteredData);
};
...
<h1><span className="live-alert"> LIVE </span> India Dashboard</h1>
</span>
<h4>As of {date}</h4>
